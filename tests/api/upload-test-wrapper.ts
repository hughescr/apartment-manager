/**
 * Test wrapper for upload.ts that bypasses SST Resource dependencies
 */
...
// Use mocked S3 client for tests
const s3Client = {
...
// Export mocked functions for test configuration
export { mockGetSignedUrl, mockRandomUUID, s3Client };
